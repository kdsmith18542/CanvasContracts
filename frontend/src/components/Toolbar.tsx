...
import { Play, CheckCircle, Upload, Save, Settings, Bug, Plus, Store } from 'lucide-react'
...
export const Toolbar: React.FC<ToolbarProps> = ({ onDebugToggle, onCustomNodeToggle, onMarketplaceToggle }) => {
